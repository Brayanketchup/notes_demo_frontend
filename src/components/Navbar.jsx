        ...
        <>
            ...
            <nav className='md:flex hidden bg-white p-5  flex-col h-[100vh] w-[250px] sticky left-0 top-0 justify-between items-center gap-4 flex-wrap'>
                <ul className='flex flex-col gap-4 w-full justify-center'>
                    ...
                    <li className='bg-[#203562] hover:bg-[#182747] transition-colors duration-150 ease-in-out p-1 rounded-lg'><a href="/" className='flex flex-row gap-2 p-1 text-white h-[30px]'> <img src="/description.svg" alt="" className='p-1' /> <h1>Notes</h1> </a> </li>
